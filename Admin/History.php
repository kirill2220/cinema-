    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>История действий всех пользователей</strong></h1>
                                                ...
                                                <table id="data-table-history" class="table table-striped" style="width:100%">
                                                    ...
                                                    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?=$row['filmname']?></td>
                                                            <td><?=$row['date']->format('j/m/Y')?></td>
                                                            <td><?=$row['datenow']->format('j/m/Y H:i:s')?></td>
                                                            <td><?=$row['place']?></td>
                                                        </tr>
                                                        <?php
                                                    }
