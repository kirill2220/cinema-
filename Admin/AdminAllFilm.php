                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div id="midf" class="mb-0">
                                                ...
                                                <table id="data-table-films" class="table table-striped" style="width:100%">
                                                    <thead>
                                                    <tr>
                                                        <th>Название</th>
                                                        <th>год</th>
                                                    ...
                                                    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?=$row['year']?></td>
                                                            <td>
                                                                <button class="btn btn-outline-primary" onclick=DelFilm(<?=$row['ID']?>)>Удалить</button>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
...
<script src="../js/AdminAllFilm.js"></script>
