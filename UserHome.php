...
<head>
    ...
    <title>Кинотеатр | DreamCinema</title>
        ...
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="User/UserFavourite.php">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="User/UserGenre.php">
    ...
    <div class="main">
                ...
                <ul class="navbar-nav navbar-align">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="User/UserProfile.php"><i class="align-middle me-1" data-feather="user"></i>
                                Профиль</a>
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3 text-center"><strong>DreamCinema</strong></h1>
                            ...
                            <div class="card search-block">
                                <div class="card-body">
                                    <div class="row search-content">
                                        <div class="col mt-0">
                                            <h4 class="text-center">Найди свой фильм</h4>
                                            <form class="form-inline my-2 my-lg-0 justify-content-center">
                                                <input class="form-control col-sm-10 mr-sm-2" type="search" id="search" placeholder="Что искать" aria-label="Search">
                                                <button class="btn btn-outline-success my-2 my-sm-0 col-sm-1" type="submit">Найти</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
