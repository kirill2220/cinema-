                                    ...
                                    <div class="row search-content">
                                        <div class="col mt-0">
                                            ...
                                            <form class="form-inline my-2 my-lg-0 justify-content-center">
                                                <input class="form-control col-sm-10 mr-sm-2" type="search" id="search"
                                                       placeholder="Что искать" aria-label="Search">
                                                <button class="btn btn-outline-success my-2 my-sm-0 col-sm-1"
                                                        type="submit">Найти
                                                </button>
                                            </form>
                                        </div>
