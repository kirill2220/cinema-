    ...
    <div class="main">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item"href="Admin/AdminProfile.php"><i class="align-middle me-1" data-feather="user"></i>
                                Профиль</a>
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3 text-center"><strong><?=$genrename?></strong></h1>
                        ...
                        <div class="w-100">
                                ...
                                <div class="container mt-5">
                                    ...
                                    <table id="data-table" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody class="row">
                                        <?php
                                        $parametrs=array($GenreId);
                                        $sql='exec ListFilmGenre ?';
